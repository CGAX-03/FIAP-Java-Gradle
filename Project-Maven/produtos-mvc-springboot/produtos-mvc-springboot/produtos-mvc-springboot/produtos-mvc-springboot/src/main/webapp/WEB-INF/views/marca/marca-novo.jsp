		                ...
		                <div class="well">
							...
							<form:form modelAttribute="marcaModel" action="${contextPath}/marca" method="post">
								...
								<div class="form-group">
									<form:input type="hidden" path="idMarca" name="idMarca" id="idMarca" value="${marca.id}" />
	                       			 </div>
							
									<div class="form-group">
										<label class="control-label" for="nome">Nome Marca:</label>
									<form:input type="text" name="nomeMarca" path="nomeMarca" id="nomeMarca" value="${marca.nomeMarca}" class="form-control" maxlength="50" size="50" />
